...
$data0 = null;
$data0[0]['TITLE'] =  'Поиск митинга | Держава, pobedim.su';
$data0[0]['SX'] = $sx;
...
$ht = new html('/derjava/poll9_search.html');
...
$r1 = new db( DB_POBEDIM, 'SELECT *  from W2_POLL_L11 (:iu,:iv, :sx , :c ,:f, :is, 9)'
...
$r2 = new db(DB_POBEDIM
            , 'SELECT * from W2_POLL_impublished_L2 (:iu,:iv, 9, :sx )'
            , [':iu' => $iu, ':iv' => $iv, ':sx' => $sx]
            );

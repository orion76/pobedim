...
$a["ranges"]='СделаемСтрануНародной';
$a["urls"]='';
$a["tkp"]='';
$a["sorting"]='';
$a["text"]=<<<'EOT'
...
**Капитализм** - это экономическая система при которой средства производства (активы) находятся в частной собственности, а не в общественной (государственной). Прибыль от активов концентрируется у собственников. Другими словами общество разделено на два класса: владельцев активов (капитала) и рабочих, создающих прибыль для владельцев капитала. Ключевой момент - это прибыль, которая зависит от жадности владельцев капитала. 
Главный идол капитализма - прибыль, каждая коммерческая структура должна бороться за максимизацию прибыли. 
Прибыль - это нетрудовой доход, являющийся источников средств для жизни социальных паразитов. Прибыль тем больше, чем меньше оплата труда трудящихся.

Сразу отвечу тем, кто вспомнит о расходах фирм, которые возникают помимо зарплаты: каждый расход в цепочке от производителя до потребителя - это чей-то доход, который распределяется на зарплату, налоги и прибыль. Налоги, кстати, разворовываются через "госзаказ" по завышенным ценам присосавшимися к бюджету олигархами.    Для мелкого капиталиста (мещанина) только "экономия" на оплате труда и налогах является источником прибыли. 

Оправдание прибыли - это то, что без прибыли невозможно развитие и обеспечение устойчивости бизнеса, ибо прибыль является источником финансирования расширения деятельности и покрытия убытков в чрезвычайных ситуациях. Прибыль - это рост активов капиталистов, который никак не влияет на благополучие трудящихся (это особенно очевидно при увольнении работника, правда жизни - всё созданное работником остаётся у собственника капитала и обеспечивает стабильность и достаток только капиталисту как в настоящем, так и в будущем).

При капитализме не имеет значение каким образом у собственника появились активы: наследство, воровство, грабёж, коррупция, удачная находка или заработок.

Для варианта "заработок" стоит обратить внимание на систему оплаты труда: какой труд считается наиболее оплачиваемый, от чего зависит размер оплаты труда и какие соотношения в оценках труда. Оценка труда - это вопрос господствующей морали. При капитализме система оплаты труда будет всегда такой, какая сохранит статус кво: рабочие должны столько, сколько достаточно только на текущее потребление.
...
Читать далее: [возврат к социализму](https://pobedim.su/-11150)
EOT;
$a["publish"]='1';
$a["tk"]='-11167';

...
*/
    ...
    function handleUpload($uploadDirectory, $replaceOldFile = FALSE){
        ...
        */
		...
		$filename = strtolower( Transliterate(  $filename ) );
		$filename = str_replace( array(' ','"',"'",'#','&','@','*','-','+','`','~','�'), '_', trim( $filename) );
		$filename =  preg_replace(array('/[^a-zA-Z0-9 -_]/', '/[ -]+/', '/^-|-$/'),  array('', '-', ''), $filename); 
		$filename = str_replace( '__','_', trim( $filename) );
...
$result = $uploader->handleUpload('c:/tmp/');
